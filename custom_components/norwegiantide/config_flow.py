...
#         if user_input is not None:
#             valid = await self._test_credentials(
#                 user_input[CONF_PLACE], user_input[CONF_LAT], user_input[CONF_LONG]
#             )
#             if valid:
#                 return self.async_create_entry(
#                     title=user_input[CONF_PLACE], data=user_input
...
#             data_schema=vol.Schema(
#                 {
#                     vol.Required(CONF_PLACE, default="ExamplePlace"): str,
#                     vol.Required(CONF_LAT, default=59.008): vol.Coerce(float),
#                     vol.Required(CONF_LONG, default=5.26): vol.Coerce(float),
#                 }
#             ),
#             errors=self._errors,
#         )
